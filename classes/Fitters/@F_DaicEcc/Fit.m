...
%       end
      ...
      flag = obj.sm{i}.n_q + obj.sm{i}.n_p == obj.sm{i}.n_qpr;
      ...
      for j = 1:n_it_level   
        ...
        if flag || mod(j,2) == 1
          [delta,c] = obj.OptimizeQP(i,tex,c);
        else
          [delta,c] = obj.OptimizeR(i,tex,c);
        end
        
        [ann,q,p,r] = obj.w{i}.UpdateAnn(obj.sm{i},ann,delta,q,p,r);
