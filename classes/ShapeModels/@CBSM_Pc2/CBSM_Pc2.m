classdef CBSM_Pc2
  ...
  methods
    function obj = CBSM_Pc2(ann,n_vert,n_ann,comp,n_comp)
      obj.pca = PCA_C();
      ...
      [obj.mu_ann,mass_ann,comp_ann] = obj.AlignCompAnn(ann,n_ann);
    ...
    [sim_mu,sim_pc,n_sim,mass_pc,comp_pc] = ComputeGlobalSimBasis(obj)
