...
%% Test GSM_Complex_Cent_Concat

disp('- GSM_Complex_Cent_Concat test');
...
% create GSM_Complex_Cent_Concat shape model
ann = ds.GetAnn();
sm = GSM_Complex_Cent_Concat(ann);
...
%% Test GSM_Complex_Cent_NWarp

disp('- GSM_Complex_Cent_NWarp test');

% create GSM_Complex_Cent_NWarp shape model
ann = ds.GetAnn();
sm = GSM_Complex_Cent_NWarp(ann);
