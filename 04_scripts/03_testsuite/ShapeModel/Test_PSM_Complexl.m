...
%% Test PSM_Complex_Concat

disp('- PSM_Complex_Concat test');
...
% create PSM_Complex_Concat shape model
ann = ds.GetAnn();
part = ds.comp;
sm = PSM_Complex_Concat(ann,part);
...
%% Test PSM_Complex_NWarp

disp('- PSM_Complex_NWarp test');

% create PSM_Complex_NWarp shape model
ann = ds.GetAnn();
part = ds.comp;
sm = PSM_Complex_NWarp(ann,part);
