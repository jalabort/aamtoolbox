...
%% Test CSM_Complex_Concat

disp('- CSM_Complex_Concat test');
...
% create CSM_Complex_Concat shape model
ann = ds.GetAnn();
part = ds.comp;
sm = CSM_Complex_Concat(ann,part);
...
%% Test CSM_Complex_NWarp

disp('- CSM_Complex_NWarp test');

% create CSM_Complex_NWarp shape model
ann = ds.GetAnn();
part = ds.comp;
sm = CSM_Complex_NWarp(ann,part);
