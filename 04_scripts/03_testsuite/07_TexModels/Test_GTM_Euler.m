...
smoother = [];
alpha = [];
tm = GTM_Euler_Real(img,rf,smoother,alpha);
...
%% Test GTM_Euler_Complex

disp('- Test GTM_Euler_Complex test');

% create Test GTM_Euler texture model
tm = GTM_Euler_Complex(img,rf,smoother,alpha);
...
%% Test GTM_Euler_Real_Double

disp('- Test GTM_Euler_Real_Double test');

% create Test GTM_Euler texture model
tm = GTM_Euler_Real_Double(img,rf,smoother,alpha);
...
%% Test GTM_Euler_Complex_Double

disp('- Test GTM_Euler_Complex_Double test');

% create Test GTM_Euler texture model
tm = GTM_Euler_Complex_Double(img,rf,smoother,alpha);
