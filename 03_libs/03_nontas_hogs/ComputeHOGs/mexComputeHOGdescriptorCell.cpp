...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    double binsSize;
    mwSize dims2[2],dims3[3],dims4[4],dims5[5],dimsCell[2];
    ...
    dimsCell[0] = numberOfOutputs;
    dimsCell[1] = 1;
    plhs[0] = mxCreateCellArray(2,dimsCell);
                ...
                if (outputWindowsCenters==0)
                {
                    if (outputWindowsFormat==0)
                    {
                        ...
                        {   // Matrix-Matrix
                            ...
                            mxSetCell(plhs[0],0,mxWindowsMatrixDescriptorsMatrix);
                        }
                        else if (outputDescriptorsFormat==1)
                        {   // Matrix-Vector
                            d = 0;
                            for (d2=0; d2<numberOfBlocksPerWindowHorizontally; d2++) {
                                for (d1=0; d1<numberOfBlocksPerWindowVertically; d1++) {
                                    for (d3=0; d3<descriptorLengthPerBlock; d3++) {
                                        ...
                                        d=d+1; }}}
                            mxSetCell(plhs[0],0,mxWindowsMatrixDescriptorsVector);
                        }
                        else if (outputDescriptorsFormat==2)
                        {   // Matrix-Matrix and Matrix-Vector
                            d = 0;
                            for (d2=0; d2<numberOfBlocksPerWindowHorizontally; d2++) {
                                for (d1=0; d1<numberOfBlocksPerWindowVertically; d1++) {
                                    for (d3=0; d3<descriptorLengthPerBlock; d3++) {
                                        ...
                                        d=d+1; }}}
                            mxSetCell(plhs[0],0,mxWindowsMatrixDescriptorsMatrix);
                            mxSetCell(plhs[0],1,mxWindowsMatrixDescriptorsVector);
                        }
                    }
                    else if (outputWindowsFormat==1)
                    {
                        ...
                        {   // Vector-Matrix
                            ...
                            mxSetCell(plhs[0],0,mxWindowsVectorDescriptorsMatrix);
                        }
                        else if (outputDescriptorsFormat==1)
                        {   // Vector-Vector
                            d = 0;
                            for (d2=0; d2<numberOfBlocksPerWindowHorizontally; d2++) {
                                for (d1=0; d1<numberOfBlocksPerWindowVertically; d1++) {
                                    for (d3=0; d3<descriptorLengthPerBlock; d3++) {
                                        ...
                                        d=d+1; }}}
                            mxSetCell(plhs[0],0,mxWindowsVectorDescriptorsVector);
                        }
                        else if (outputDescriptorsFormat==2)
                        {   // Vector-Matrix and Vector-Vector
                            d = 0;
                            for (d2=0; d2<numberOfBlocksPerWindowHorizontally; d2++) {
                                for (d1=0; d1<numberOfBlocksPerWindowVertically; d1++) {
                                    for (d3=0; d3<descriptorLengthPerBlock; d3++) {
                                        ...
                                        d=d+1; }}}
                            mxSetCell(plhs[0],0,mxWindowsVectorDescriptorsMatrix);
                            mxSetCell(plhs[0],1,mxWindowsVectorDescriptorsVector);
                        }
                    }
                    else if (outputWindowsFormat==2)
                    {
                            ...
                            for (d2=0; d2<numberOfBlocksPerWindowHorizontally; d2++) {
                                for (d1=0; d1<numberOfBlocksPerWindowVertically; d1++) {
                                    for (d3=0; d3<descriptorLengthPerBlock; d3++) {
                                        ...
                                        WindowsVectorDescriptorsMatrix[windowCounter+numberOfWindows*(d1+numberOfBlocksPerWindowVertically*(d2+numberOfBlocksPerWindowHorizontally*d3))] = descriptorMatrix[d1+numberOfBlocksPerWindowVertically*(d2+numberOfBlocksPerWindowHorizontally*d3)]; } } }
                            mxSetCell(plhs[0],0,mxWindowsMatrixDescriptorsMatrix);
                            mxSetCell(plhs[0],1,mxWindowsVectorDescriptorsMatrix);
                        }
                        else if (outputDescriptorsFormat==1)
                        {   // Matrix-Vector and Vector-Vector
                            d = 0;
                        ...
                        {   // Matrix-Matrix and Vector-Matrix and Matrix-Vector and Vector-Vector
                            ...
                            mxSetCell(plhs[0],0,mxWindowsMatrixDescriptorsMatrix);
                            mxSetCell(plhs[0],1,mxWindowsVectorDescriptorsMatrix);
                            mxSetCell(plhs[0],2,mxWindowsMatrixDescriptorsVector);
                            mxSetCell(plhs[0],3,mxWindowsVectorDescriptorsVector);
                        }
                    }
                }
                else if (outputWindowsCenters==1)
                {
                    if (outputWindowsFormat==0)
                    {
                        ...
                        {   // Matrix-Matrix
                            ...
                            mxSetCell(plhs[0],0,mxWindowsMatrixDescriptorsMatrix);
                            mxSetCell(plhs[0],1,mxWindowsCentersMatrix);
                        }
                        else if (outputDescriptorsFormat==1)
                        {   // Matrix-Vector
                            d = 0;
                        ...
                        {   // Matrix-Matrix and Matrix-Vector
                            ...
                            mxSetCell(plhs[0],0,mxWindowsMatrixDescriptorsMatrix);
                            mxSetCell(plhs[0],1,mxWindowsMatrixDescriptorsVector);
                            mxSetCell(plhs[0],2,mxWindowsCentersMatrix);
                        }
                    }
                    else if (outputWindowsFormat==1)
                    {
                        ...
                        {   // Vector-Matrix
                            ...
                            mxSetCell(plhs[0],0,mxWindowsVectorDescriptorsMatrix);
                            mxSetCell(plhs[0],1,mxWindowsCentersVector);
                        }
                        else if (outputDescriptorsFormat==1)
                        {   // Vector-Vector
                            d = 0;
                        ...
                        {   // Vector-Matrix and Vector-Vector
                            ...
                            mxSetCell(plhs[0],0,mxWindowsVectorDescriptorsMatrix);
                            mxSetCell(plhs[0],1,mxWindowsVectorDescriptorsVector);
                            mxSetCell(plhs[0],2,mxWindowsCentersVector);
                        }
                    }
                    else if (outputWindowsFormat==2)
                    {
                        ...
                        {   // Matrix-Matrix and Vector-Matrix
                            ...
                            mxSetCell(plhs[0],1,mxWindowsVectorDescriptorsMatrix);
                            mxSetCell(plhs[0],2,mxWindowsCentersMatrix);
                            mxSetCell(plhs[0],3,mxWindowsCentersVector);
                        }
                        else if (outputDescriptorsFormat==1)
                        {   // Matrix-Vector and Vector-Vector
                            d = 0;
                        ...
                        {   // Matrix-Matrix and Vector-Matrix and Matrix-Vector and Vector-Vector
                            ...
                            mxSetCell(plhs[0],2,mxWindowsMatrixDescriptorsVector);
                            mxSetCell(plhs[0],3,mxWindowsVectorDescriptorsVector);
                            mxSetCell(plhs[0],4,mxWindowsCentersMatrix);
                            mxSetCell(plhs[0],5,mxWindowsCentersVector);
                        }
                    }
                }
            }
