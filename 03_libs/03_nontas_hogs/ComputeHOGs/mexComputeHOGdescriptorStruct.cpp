...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    mxArray *mxWindowsMatrixDescriptorsMatrix, *mxWindowsMatrixDescriptorsVector, *mxWindowsVectorDescriptorsMatrix, *mxWindowsVectorDescriptorsVector;
    mxArray *mxWindowsCentersMatrix, *mxWindowsCentersVector;
    ...
    else
    {
        ...
        options[0] = 1; //windowHeight
        options[1] = 1; //windowWidth
    ...
    // Initialize output struct and matrices
    if (outputWindowsCenters==0)
    {
        if (outputWindowsFormat==0)
        {
            ...
            {   // Matrix-Matrix
                ...
                const char *fieldnames[] = {"WindowsMatrixDescriptorsMatrix"};
                plhs[0] = mxCreateStructMatrix(1,1,numberOfOutputs,fieldnames);
            }
            else if (outputDescriptorsFormat==1)
            {   // Matrix-Vector
                ...
                mxWindowsMatrixDescriptorsVector = mxCreateNumericArray(3,dims3,mxDOUBLE_CLASS,mxREAL);
                WindowsMatrixDescriptorsVector = mxGetPr(mxWindowsMatrixDescriptorsVector);
                
                const char *fieldnames[] = {"WindowsMatrixDescriptorsVector"};
                plhs[0] = mxCreateStructMatrix(1,1,numberOfOutputs,fieldnames);
            }
            else if (outputDescriptorsFormat==2)
            {   // Matrix-Matrix and Matrix-Vector
                ...
                const char *fieldnames[] = {"WindowsMatrixDescriptorsMatrix","WindowsMatrixDescriptorsVector"};
                plhs[0] = mxCreateStructMatrix(1,1,numberOfOutputs,fieldnames);
            }
        }
        else if (outputWindowsFormat==1)
        {
            ...
            {   // Vector-Matrix
                ...
                mxWindowsVectorDescriptorsMatrix = mxCreateNumericArray(4,dims4,mxDOUBLE_CLASS,mxREAL);
                WindowsVectorDescriptorsMatrix = mxGetPr(mxWindowsVectorDescriptorsMatrix);
                
                const char *fieldnames[] = {"WindowsVectorDescriptorsMatrix"};
                plhs[0] = mxCreateStructMatrix(1,1,numberOfOutputs,fieldnames);
            }
            else if (outputDescriptorsFormat==1)
            {   // Vector-Vector
                ...
                mxWindowsVectorDescriptorsVector = mxCreateNumericArray(2,dims2,mxDOUBLE_CLASS,mxREAL);
                WindowsVectorDescriptorsVector = mxGetPr(mxWindowsVectorDescriptorsVector);
                
                const char *fieldnames[] = {"WindowsVectorDescriptorsVector"};
                plhs[0] = mxCreateStructMatrix(1,1,numberOfOutputs,fieldnames);
            }
            else if (outputDescriptorsFormat==2)
            {   // Vector-Matrix and Vector-Vector
                ...
                const char *fieldnames[] = {"WindowsVectorDescriptorsMatrix","WindowsVectorDescriptorsVector"};
                plhs[0] = mxCreateStructMatrix(1,1,numberOfOutputs,fieldnames);
            }
        }
        else if (outputWindowsFormat==2)
        {
            ...
            {   // Matrix-Matrix and Vector-Matrix
                ...
                const char *fieldnames[] = {"WindowsMatrixDescriptorsMatrix","WindowsVectorDescriptorsMatrix"};
                plhs[0] = mxCreateStructMatrix(1,1,numberOfOutputs,fieldnames);
            }
            else if (outputDescriptorsFormat==1)
            {   // Matrix-Vector and Vector-Vector
                ...
                const char *fieldnames[] = {"WindowsMatrixDescriptorsVector","WindowsVectorDescriptorsVector"};
                plhs[0] = mxCreateStructMatrix(1,1,numberOfOutputs,fieldnames);
            }
            else if (outputDescriptorsFormat==2)
            {   // Matrix-Matrix and Vector-Matrix and Matrix-Vector and Vector-Vector
                ...
                const char *fieldnames[] = {"WindowsMatrixDescriptorsMatrix","WindowsVectorDescriptorsMatrix","WindowsMatrixDescriptorsVector","WindowsVectorDescriptorsVector"};
                plhs[0] = mxCreateStructMatrix(1,1,numberOfOutputs,fieldnames);
            }
        }
    }
    else if (outputWindowsCenters==1)
    {
        if (outputWindowsFormat==0)
        {
            ...
            {   // Matrix-Matrix
                ...
                const char *fieldnames[] = {"WindowsMatrixDescriptorsMatrix","WindowsCentersMatrix"};
                plhs[0] = mxCreateStructMatrix(1,1,numberOfOutputs,fieldnames);
            }
            else if (outputDescriptorsFormat==1)
            {   // Matrix-Vector
                ...
                const char *fieldnames[] = {"WindowsMatrixDescriptorsVector","WindowsCentersMatrix"};
                plhs[0] = mxCreateStructMatrix(1,1,numberOfOutputs,fieldnames);
            }
            else if (outputDescriptorsFormat==2)
            {   // Matrix-Matrix and Matrix-Vector
                ...
                const char *fieldnames[] = {"WindowsMatrixDescriptorsMatrix","WindowsMatrixDescriptorsVector","WindowsCentersMatrix"};
                plhs[0] = mxCreateStructMatrix(1,1,numberOfOutputs,fieldnames);
            }
            dims3[0] = numberOfWindowsVertically;
            dims3[1] = numberOfWindowsHorizontally;
        ...
        else if (outputWindowsFormat==1)
        {
            ...
            {   // Vector-Matrix
                ...
                const char *fieldnames[] = {"WindowsVectorDescriptorsMatrix","WindowsCentersVector"};
                plhs[0] = mxCreateStructMatrix(1,1,numberOfOutputs,fieldnames);
            }
            else if (outputDescriptorsFormat==1)
            {   // Vector-Vector
                ...
                const char *fieldnames[] = {"WindowsVectorDescriptorsVector","WindowsCentersVector"};
                plhs[0] = mxCreateStructMatrix(1,1,numberOfOutputs,fieldnames);
            }
            else if (outputDescriptorsFormat==2)
            {   // Vector-Matrix and Vector-Vector
                ...
                const char *fieldnames[] = {"WindowsVectorDescriptorsMatrix","WindowsVectorDescriptorsVector","WindowsCentersVector"};
                plhs[0] = mxCreateStructMatrix(1,1,numberOfOutputs,fieldnames);
            }
            dims2[0] = numberOfWindows;
            dims2[1] = 2;
            mxWindowsCentersVector = mxCreateNumericArray(2,dims2,mxDOUBLE_CLASS,mxREAL);
            WindowsCentersVector = mxGetPr(mxWindowsCentersVector);
        }
        else if (outputWindowsFormat==2)
        {
            if (outputDescriptorsFormat==0)
            {   // Matrix-Matrix and Vector-Matrix
                ...
                const char *fieldnames[] = {"WindowsMatrixDescriptorsMatrix","WindowsVectorDescriptorsMatrix","WindowsCentersMatrix","WindowsCentersVector"};
                plhs[0] = mxCreateStructMatrix(1,1,numberOfOutputs,fieldnames);
            }
            else if (outputDescriptorsFormat==1)
            {   // Matrix-Vector and Vector-Vector
                ...
                const char *fieldnames[] = {"WindowsMatrixDescriptorsVector","WindowsVectorDescriptorsVector","WindowsCentersMatrix","WindowsCentersVector"};
                plhs[0] = mxCreateStructMatrix(1,1,numberOfOutputs,fieldnames);
            }
            else if (outputDescriptorsFormat==2)
            {   // Matrix-Matrix and Vector-Matrix and Matrix-Vector and Vector-Vector
                ...
                const char *fieldnames[] = {"WindowsMatrixDescriptorsMatrix","WindowsVectorDescriptorsMatrix","WindowsMatrixDescriptorsVector","WindowsVectorDescriptorsVector","WindowsCentersMatrix","WindowsCentersVector"};
                plhs[0] = mxCreateStructMatrix(1,1,numberOfOutputs,fieldnames);
            }
            dims3[0] = numberOfWindowsVertically;
            dims3[1] = numberOfWindowsHorizontally;
                            ...
                            for (d2=0; d2<numberOfBlocksPerWindowHorizontally; d2++) {
                                for (d1=0; d1<numberOfBlocksPerWindowVertically; d1++) {
                                    for (d3=0; d3<descriptorLengthPerBlock; d3++) {
                                        ...
                                        d=d+1; }}}
                            mxSetFieldByNumber(plhs[0],0,0,mxWindowsMatrixDescriptorsVector);
                        }
                        else if (outputDescriptorsFormat==2)
                        {   // Matrix-Matrix and Matrix-Vector
                            d = 0;
                            for (d2=0; d2<numberOfBlocksPerWindowHorizontally; d2++) {
                                for (d1=0; d1<numberOfBlocksPerWindowVertically; d1++) {
                                    for (d3=0; d3<descriptorLengthPerBlock; d3++) {
                                        ...
                                        d=d+1; }}}
                            mxSetFieldByNumber(plhs[0],0,0,mxWindowsMatrixDescriptorsMatrix);
                            mxSetFieldByNumber(plhs[0],0,1,mxWindowsMatrixDescriptorsVector);
                        }
                    }
                    else if (outputWindowsFormat==1)
                    {
                        ...
                        {   // Vector-Matrix
                            ...
                            mxSetFieldByNumber(plhs[0],0,0,mxWindowsVectorDescriptorsMatrix);
                        }
                        else if (outputDescriptorsFormat==1)
                        {   // Vector-Vector
                            d = 0;
                            for (d2=0; d2<numberOfBlocksPerWindowHorizontally; d2++) {
                                for (d1=0; d1<numberOfBlocksPerWindowVertically; d1++) {
                                    for (d3=0; d3<descriptorLengthPerBlock; d3++) {
                                        ...
                                        d=d+1; }}}
                            mxSetFieldByNumber(plhs[0],0,0,mxWindowsVectorDescriptorsVector);
                        }
                        else if (outputDescriptorsFormat==2)
                        {   // Vector-Matrix and Vector-Vector
                            d = 0;
                            for (d2=0; d2<numberOfBlocksPerWindowHorizontally; d2++) {
                                for (d1=0; d1<numberOfBlocksPerWindowVertically; d1++) {
                                    for (d3=0; d3<descriptorLengthPerBlock; d3++) {
                                        ...
                                        d=d+1; }}}
                            mxSetFieldByNumber(plhs[0],0,0,mxWindowsVectorDescriptorsMatrix);
                            mxSetFieldByNumber(plhs[0],0,1,mxWindowsVectorDescriptorsVector);
                        }
                    }
                    else if (outputWindowsFormat==2)
                    {
                            ...
                            for (d2=0; d2<numberOfBlocksPerWindowHorizontally; d2++) {
                                for (d1=0; d1<numberOfBlocksPerWindowVertically; d1++) {
                                    for (d3=0; d3<descriptorLengthPerBlock; d3++) {
                                        ...
                                        WindowsVectorDescriptorsMatrix[windowCounter+numberOfWindows*(d1+numberOfBlocksPerWindowVertically*(d2+numberOfBlocksPerWindowHorizontally*d3))] = descriptorMatrix[d1+numberOfBlocksPerWindowVertically*(d2+numberOfBlocksPerWindowHorizontally*d3)]; } } }
                            mxSetFieldByNumber(plhs[0],0,0,mxWindowsMatrixDescriptorsMatrix);
                            mxSetFieldByNumber(plhs[0],0,1,mxWindowsVectorDescriptorsMatrix);
                        }
                        else if (outputDescriptorsFormat==1)
                        {   // Matrix-Vector and Vector-Vector
                            d = 0;
                        ...
                        {   // Matrix-Matrix and Vector-Matrix and Matrix-Vector and Vector-Vector
                            ...
                            mxSetFieldByNumber(plhs[0],0,0,mxWindowsMatrixDescriptorsMatrix);
                            mxSetFieldByNumber(plhs[0],0,1,mxWindowsVectorDescriptorsMatrix);
                            mxSetFieldByNumber(plhs[0],0,2,mxWindowsMatrixDescriptorsVector);
                            mxSetFieldByNumber(plhs[0],0,3,mxWindowsVectorDescriptorsVector);
                        }
                    }
                }
                else if (outputWindowsCenters==1)
                {
                    if (outputWindowsFormat==0)
                    {
                        ...
                        {   // Matrix-Matrix and Matrix-Vector
                            ...
                            mxSetFieldByNumber(plhs[0],0,0,mxWindowsMatrixDescriptorsMatrix);
                            mxSetFieldByNumber(plhs[0],0,1,mxWindowsMatrixDescriptorsVector);
                            mxSetFieldByNumber(plhs[0],0,2,mxWindowsCentersMatrix);
                        }
                    }
                    else if (outputWindowsFormat==1)
                    {
                        ...
                        {   // Vector-Matrix
                            ...
                            mxSetFieldByNumber(plhs[0],0,0,mxWindowsVectorDescriptorsMatrix);
                            mxSetFieldByNumber(plhs[0],0,1,mxWindowsCentersVector);
                        }
                        else if (outputDescriptorsFormat==1)
                        {   // Vector-Vector
                            d = 0;
                        ...
                        {   // Vector-Matrix and Vector-Vector
                            ...
                            mxSetFieldByNumber(plhs[0],0,0,mxWindowsVectorDescriptorsMatrix);
                            mxSetFieldByNumber(plhs[0],0,1,mxWindowsVectorDescriptorsVector);
                            mxSetFieldByNumber(plhs[0],0,2,mxWindowsCentersVector);
                        }
                    }
                    else if (outputWindowsFormat==2)
                    {
                        ...
                        {   // Matrix-Matrix and Vector-Matrix
                            ...
                            mxSetFieldByNumber(plhs[0],0,1,mxWindowsVectorDescriptorsMatrix);
                            mxSetFieldByNumber(plhs[0],0,2,mxWindowsCentersMatrix);
                            mxSetFieldByNumber(plhs[0],0,3,mxWindowsCentersVector);
                        }
                        else if (outputDescriptorsFormat==1)
                        {   // Matrix-Vector and Vector-Vector
                            d = 0;
                        ...
                        {   // Matrix-Matrix and Vector-Matrix and Matrix-Vector and Vector-Vector
                            ...
                            mxSetFieldByNumber(plhs[0],0,2,mxWindowsMatrixDescriptorsVector);
                            mxSetFieldByNumber(plhs[0],0,3,mxWindowsVectorDescriptorsVector);
                            mxSetFieldByNumber(plhs[0],0,4,mxWindowsCentersMatrix);
                            mxSetFieldByNumber(plhs[0],0,5,mxWindowsCentersVector);
                        }
                    }
                }
            }
