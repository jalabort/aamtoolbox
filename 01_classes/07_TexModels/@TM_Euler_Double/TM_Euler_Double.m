classdef TM_Euler_Double < TM
  %TM_EULER_DOUBLE Summary of this class goes here
  ...
  methods
    function obj = TM_Euler_Double(img,n_img,mask,n_face_pixels,res,mask2,n_face_pixels2,smoother,g_type,alpha)
