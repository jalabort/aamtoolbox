...
opt.m.sigma = {1,2,3};
opt.m.shape_model = {'cb-pc4','cb-pc4','cb-pc4'};
opt.m.tex_model = 'pi';
opt.m.alpha = 1.99;
...
opt.id = 1:330%146 % [5,7,15,21,49,52,64,79,88,146,174,188,208,236,287,289,303,320,322];%1:50;
opt.test_reg_exp_query = test_db.RegExpQuery(opt.id);

% Specify Fitting Options
opt.n_it = 100;
opt.n_c = {100,100,50};  % tex

opt.n_p2 = {2,2,2};    % mass
opt.n_r = {0, 0, 0;    % component 1: mouth
          0, 0, 0;    % component 2: nose
           0, 0, 0;    % component 3: left eye
           0, 0, 0;    % component 4: right eye
           0, 0, 0;    % component 5: jaw
